"""Stable public surface for scripting Terranova from notebooks / Python console.

The intent is that everything reachable from this module is considered API and
covered by semantic versioning.  Internal modules (``terranova.core.*``,
``terranova.controllers.*``) may change between minor versions; ``terranova.api``
may not.
...
def search_sentinel2(
    ...
    *,
    ...
    Earth Search instead, call :mod:`terranova.core.catalog.stac` directly.
    """
