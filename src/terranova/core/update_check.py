...
LATEST_URL = "https://terranova.app/latest.json"
USER_AGENT = f"Terranova/{__version__} (update-check)"
...
def _cache_path() -> Path:
    try:
        ...
        return Path(platformdirs.user_cache_dir("terranova")) / "update_check.json"
    except ImportError:  # pragma: no cover
        return Path.home() / ".cache" / "terranova" / "update_check.json"
