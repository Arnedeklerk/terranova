...
_LOG = logging.getLogger("terranova")
...
def log(message: str, *, level: int = logging.INFO, tag: str = "Terranova") -> None:
...
def info(message: str, *, tag: str = "Terranova") -> None:
    log(message, level=logging.INFO, tag=tag)


def warning(message: str, *, tag: str = "Terranova") -> None:
    log(message, level=logging.WARNING, tag=tag)


def error(message: str, *, tag: str = "Terranova") -> None:
