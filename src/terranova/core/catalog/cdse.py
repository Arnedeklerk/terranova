...
def token_cache_path() -> Path:
    ...
    try:
        ...
        return Path(platformdirs.user_cache_dir("terranova")) / "cdse_token.json"
    except ImportError:  # pragma: no cover
        return Path.home() / ".cache" / "terranova" / "cdse_token.json"
...
def get_token() -> CDSEToken:
    ...
    print(
        f"[Terranova CDSE] Open {challenge.verification_uri_complete} "
