...
The CLI is a thin argparse wrapper around the ``terrascope.api`` surface; it
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="terrascope",
        description="TerraScope CLI — pure-Python core operations outside QGIS.",
    )
    p.add_argument("--version", action="version", version=f"terrascope {__version__}")
