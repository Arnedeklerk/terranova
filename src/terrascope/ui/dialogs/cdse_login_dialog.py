...
class CdseLoginDialog(QDialog):
    ...
    def __init__(self, iface: "QgisInterface", parent: QWidget | None = None) -> None:
        ...
        self.setWindowTitle("TerraScope — Sign in to Copernicus Data Space")
        self.resize(520, 280)
    ...
    def _on_done(self) -> None:
        ...
        self.iface.messageBar().pushSuccess("TerraScope", "Signed in to CDSE.")
    ...
    def _signout(self) -> None:
        ...
        self.iface.messageBar().pushInfo("TerraScope", "Signed out of CDSE.")
