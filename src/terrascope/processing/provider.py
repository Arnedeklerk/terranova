"""TerraScope Processing provider — registers all algorithms in QGIS Processing."""
...
class TerraScopeProcessingProvider(QgsProcessingProvider):
    """The provider that owns every TerraScope Processing algorithm."""
    ...
    def longName(self) -> str:
        return f"TerraScope v{__version__}"
