"""TerraScope QGIS plugin lifecycle.
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from .ui.plugin_dock import TerraScopeDock
...
class TerraScopePlugin:
    ...
    def __init__(self, iface: "QgisInterface") -> None:
        ...
        self.dock: TerraScopeDock | None = None
    ...
    def initGui(self) -> None:
        ...
        self.action_classify.setObjectName("terrascope_open_classify")
        ...
        self.action_accuracy.setObjectName("terrascope_open_accuracy")
        ...
        self.action_sam.setObjectName("terrascope_open_sam")
        ...
        self.action_foundation.setObjectName("terrascope_open_foundation")
        ...
        self.action_timeseries.setObjectName("terrascope_open_timeseries")
        ...
        self.action_cdse.setObjectName("terrascope_open_cdse")
    ...
    def _toggle_dock(self, checked: bool) -> None:
        if self.dock is None:
            ...
            self.dock = TerraScopeDock(self.iface)
    ...
    def _open_dialog(self, module: str, klass: str, attr: str) -> None:
        try:
            mod = __import__(f"terrascope.ui.dialogs.{module}", fromlist=[klass])
    ...
    def _register_processing_provider(self) -> None:
        try:
            ...
            from .processing.provider import TerraScopeProcessingProvider
        except ImportError:  # pragma: no cover — pyqgis missing in tests
            return

        self._provider = TerraScopeProcessingProvider()
