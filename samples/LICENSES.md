...
TerraScope only ships samples that are licensed for redistribution.
...
| `khartoum_classes.geojson` | Hand-digitised by the TerraScope team over the imagery above | CC0 | 50 polygons, 5 classes |
